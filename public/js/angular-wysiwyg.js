    ...
    angular.module('wysiwyg.module', ['colorpicker.module'])
        .directive('wysiwyg', function($timeout, wysiwgGui, $compile) {
            return {
                ...
                '<div id="{{textareaId}}" ' +
                'ng-attr-style="resize:vertical;height:{{textareaHeight || \'80px\'}}; overflow:auto" ' +
                'contentEditable="{{!disabled}}" ' +
                'class="{{textareaClass}} wysiwyg-textarea" ' +
                'rows="{{textareaRows}}" ' +
                'name="{{textareaName}}" ' +
            ...
            function link(scope, element, attrs, ngModelController) {
                ...
                scope.openMediaModal = function(){
                    ...
                    //var imgdata = JSON.parse(attrs.mediaPhoto);
                    ...
                    //scope.format('insertHTML', '<img src="'+imgdata.image+'/'+imgdata.maxwidth+'" class="img-responsive '+imgdata.float+'">');

                }

                //scope.dupa = attrs.mediaPhoto;
                //
                //
                //scope.$watch('dupa', function(newValue, oldValue) {
