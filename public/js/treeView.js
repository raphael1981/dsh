    ...
    module.directive('treeView', ['$q', 'treeViewDefaults', function ($q, treeViewDefaults) {
        return {
            ...
            controller: ['$scope', function ($scope) {
                ...
                //console.log($scope.treeViewOptions);
    ...
    module.directive('treeViewNode', ['$q', '$compile', function ($q, $compile) {
        return {
            ...
            link: function (scope, element, attrs, controller) {
                ...
                //console.log();
                scope.hidefiles = options.hidefiles;
                ...
                function render() {
                    var template =
                        ...
                        '</div>' +
                        '</div>' +
                        '<a href="#" class="tree-item" ng-if="!hidefiles" ng-repeat="file in ' + attrs.treeViewNode + '.' + filesProperty + '" ng-click="selectFile(file, $event)" ng-class="{ selected: isSelected(file) }">' +
