  ...
  function ckeditorController($scope, $element, $attrs, $parse, $q) {
    // var config = $parse($attrs.ckeditor)($scope) || {};
      ...
      var config = {
          ...
          allowedContent: 'iframe[*]; p b i img[*]; ul li ol a[*]; h1 h2 h3 h4 h5'
      };
...
/*        instance = this.instance = CKEDITOR.replace( editorElement,
            {
                filebrowserBrowseUrl: '/filemanager_cfl/index.html',
                toolbar:'Full'
