...
app.directive('showSearchCriteria', function() {
    return {
        templateUrl: '/templates/admin/super/groups/search.html'
    };
});
...
app.controller('GroupsController',['$scope', '$http', '$log', '$q', '$location','AppService', '$window', '$filter', '$timeout','$route','$routeParams', '$rootScope', function($scope, $http, $log, $q, $location,AppService, $window, $filter, $timeout,$route, $routeParams, $rootScope) {
    ...
    $scope.getElements = function(iterstart){
        ...
        $http.post(AppService.url + '/administrator/get/groups',
            {
                start:$scope.start,
                limit:$scope.limit,
                frase:$scope.frase,
...
app.controller('NewGroupController',['$scope', '$http', '$log', '$q', '$location','AppService', '$window', '$filter', '$timeout','$route','$routeParams', '$rootScope', 'ngDialog', '$sce', 'Upload', '$interval', function($scope, $http, $log, $q, $location,AppService, $window, $filter, $timeout,$route, $routeParams,$rootScope, ngDialog, $sce, Upload,$interval) {
...
app.config(function($routeProvider, $locationProvider) {
    ...
    $routeProvider.
    when('/', {
        templateUrl: '/templates/admin/super/groups/master.html',
        controller: 'GroupsController'
    }).
    when('/add', {
        templateUrl: '/templates/admin/super/groups/new-member.html',
        controller: 'NewGroupController'
    }).
    when('/:id', {
        templateUrl: '/templates/admin/super/groups/edit-member.html',
