...
app.controller('FilterCategoryContentYearController', ['$scope', '$http', '$log', '$q', '$location', '$window', '$filter', '$timeout','$rootScope', 'AppService', 'DateService', function($scope, $http, $log, $q, $location, $window, $filter, $timeout,$rootScope,AppService,DateService) {
    ...
    $scope.getFiltersResult = function(){
        ...
        $http.post(AppService.url+'/api/get/filter/content/result', {filters:cats,
...
app.controller('FilterCategoryContentNoYearController', ['$scope', '$http', '$log', '$q', '$location', '$window', '$filter', '$timeout','$rootScope', 'AppService', 'DateService', function($scope, $http, $log, $q, $location, $window, $filter, $timeout,$rootScope,AppService,DateService) {
    ...
    $scope.getFiltersResult = function(){
        ...
        $http.post(AppService.url+'/api/get/filter/content/noyear/result', {filters:cats,
                year:$scope.data.selected_year,
                current_month:$scope.data.current_month,
                is_current_year:is_current_year,
                current_day:$scope.data.current_day,
...
app.controller('FilterCategoryStaticController', ['$scope', '$http', '$log', '$q', '$location', '$window', '$filter', '$timeout','$rootScope', 'AppService', 'DateService', function($scope, $http, $log, $q, $location, $window, $filter, $timeout,$rootScope,AppService,DateService) {
    ...
    $scope.getFiltersResult = function() {
        ...
        $http.post(AppService.url+'/api/get/filter/content/static/result', {
                full_filter_collection:$scope.all_filters,
                order:$scope.order})
            .then(
                function successCallback(response){
