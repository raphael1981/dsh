...
app.directive('resize', function ($window,$timeout) {
    return function (scope, element, attr) {
        ...
        scope.$watch(function () {
            ...
            //console.log(angular.element(document.getElementById('content-first')).height());
            //var change = angular.element(document.getElementById('content-first')).height()+angular.element(document.getElementById('plus-content-height')).height();
            //angular.element(document.getElementById('scale-by-content-first')).css({'height': change});
...
app.controller('UnstandardController', ['$scope', '$http', '$log', '$q', '$location', '$window', '$filter', '$timeout','$rootScope', 'AppService', function($scope, $http, $log, $q, $location, $window, $filter, $timeout,$rootScope,AppService) {
