...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="{{ asset('css/angular-moment-picker.css') }}">
...
<script type="text/javascript" src="{{ asset('js/angular-moment-picker.js') }}"></script>
...
<script type="text/javascript" src="{{ asset('ng-ckeditor/angular-ckeditor.js') }}"></script>
...
<script type="text/javascript" src="{{ asset('tree/TreeDirectives.js') }}"></script>
<script type="text/javascript" src="{{ asset('directives/select-rotors.js') }}"></script>
<script type="text/javascript" src="{{ asset('directives/update-rotor.js') }}"></script>
