<!DOCTYPE html>
<html lang="{{ config('app.locale') }}" ng-app="app" xmlns="http://www.w3.org/1999/html">
<head>
    <meta charset="utf-8">
    ...
    <link type="text/css" rel="stylesheet" href="{{ asset('css/ngDialog-theme-middle.css') }}">
    ...
    <link type="text/css" rel="stylesheet" href="{{ asset('css/angular-ui-tree.css') }}">
...
<body ng-controller="GlobalController" class="alphaHide" id="body" ng-init="language='{{ $lang["id"] }}'">
<div id="app">
...
<script type="text/javascript" src="{{ asset('js/angular-ui-tree.js') }}"></script>
